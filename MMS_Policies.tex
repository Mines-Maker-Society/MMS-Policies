...
\begin{enumerate}
    ...
    \item Head of Interoperation
    \begin{enumerate}
        \item Lead co-operative projects with other school organizations (such as the Mines Foundation) and clubs to provide the services of the Blaster Design Factory
    ...
    \begin{enumerate}
        ...
        \item May, under consent of the Executive Board, have their event hosting requirement waived to focus on aiding all other members with their events.
    \end{enumerate}
    ...
    \item Webmaster 
    \begin{enumerate}
        \item Update and maintain the club Discord
        \item Update and maintain any club websites
    \end{enumerate}
    ...
    \item Clerk
    \begin{enumerate}
        \item Shall review tasks assigned to club members and help ensure their completion through collaborative means such as reminding the taskholder or working with them to effectively break up or delegate the task
...
Chairs of the Mines Maker Society should abide by the following expectations:
...
\begin{itemize}
    ...
    \item If you take tools or materials out of any of the chests, cabinets, materials cart, or the cage, return what was removed back to it’s designated location once you finish your work for the day.
...
\begin{itemize}
    ...
    \item All curing epoxy and components with curing epoxy must remain in the designated epoxy curing area until the epoxy has fully hardened. The epoxy curing area is marked with yellow floor marking tape.
...
usage limits and access control is established here.
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Additional usage may be approved by the Leadership Board.
    \end{itemize}
...
\end{itemize}
\subsection{Sanctions}
Failure to abide by this policy will result in the loss of vinyl cutter/printer privileges.
\subsection{Review}
This policy shall be reviewed at least annually by Maker Society Leadership.
...
\subsection{Policy}
\begin{itemize}
   \item Trusted operators are individuals which the Leadership Board approves to assist in the day-to-day operation of the space.
   \item Trusted operators are to wear badges which contain:
   \begin{itemize}
    \item the operator's name,
    \item the endorsements held by the operator.
   \end{itemize}
   \item Trusted operator status may be revoked and assigned by a simple majority vote of the Leadership board.
   \item Endorsements may be revoked and assigned by a simple majority vote of the Leadership Board.
   \item Persons who are not classified as Trusted Operators may not wear Trusted Operator badges.
   \item Falsifying Trusted Operator status is grounds for dismissal from the Space and application of sanctions as assigned by the Leadership Board
   \item Trusted operators are expected to stay up-to-date on space tools and operations thereof.
   \item Trusted operators must follow all current rules of the Mines Maker Society.
   \item Trusted operator status is overridden by probation. 
   Persons on probation may not act as Trusted Operators.
   Trusted Operators may not possess their badge while on probation.
   \item Trusted operators may:
   \begin{itemize}
    \item approve oversize and overtime prints,
    \item may prevent any activity from being performed,
    \item have access to internal space communications,
    \item decommission tools and machinery,
    \item perform filament changes,
    \item perform tool checkouts,
    \item perform Blaster Design Factory trainings, and,
    \item hold open and lock the space.
   \end{itemize}
   \item Trusted operators may not:
   \begin{itemize}
    \item may not access restricted access tools without special endorsement,
    \item may not perform maintenance or repairs on any machinery without Head Technician approval 
    \item violate any rules of the Mines Maker Society.
   \end{itemize}
\end{itemize}
\subsection{Sanctions}
Failure to abide by the expectations defined above as determined by the Leadership Board will result in loss of Trusted Operator status.
